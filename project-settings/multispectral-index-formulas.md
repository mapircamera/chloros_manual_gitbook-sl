...
Pri uporabi teh formul se ime lahko konča z „\_1” ali „\_2”, kar ustreza filtru NIR, pri čemer je bil uporabljen filter NIR1 ali NIR2.
...
Gozdna območja bodo imela nižje vrednosti FCI1 zaradi nižjega odboja dreves in prisotnosti senc v krošnjah.
...
Ta nelinearen indeks vegetacije se uporablja za globalno spremljanje okolja iz satelitskih posnetkov in poskuša popraviti atmosferske vplive. Je podoben NDVI, vendar je manj občutljiv na atmosferske vplive. Nanj vpliva gola tla, zato se ne priporoča za uporabo na območjih z redko ali zmerno gosto vegetacijo.
...
_Sklic: Pinty, B., in M. Verstraete. GEMI: nelinearen indeks za spremljanje globalne vegetacije s satelitov. Vegetation 101 (1992): 15–20._
...
Ta indeks je bil prvotno zasnovan za uporabo z digitalno kamero RGB za merjenje pokritosti pšenice, pri čemer se rdeče, zelene in modre digitalne številke (DN) gibljejo od 0 do 255.
...
_Sklic: Louhaichi, M., M. Borman in D. Johnson. „Prostorsko locirana platforma in letalska fotografija za dokumentiranje vpliva paše na pšenico.“ Geocarto International 16, št. 1 (2001): 65–70._

***

## GNDVI – Green Normalizirani indeks razlike v vegetaciji

Ta indeks je podoben NDVI, razen da meri zeleno spektro od 540 do 570 nm namesto rdeče spektro. Ta indeks je bolj občutljiv na koncentracijo klorofila kot NDVI.
...
_Sklic: Sripada, R., et al. »Aerial Color Infrared Photography for Determining Early In-season Nitrogen Requirements in Corn« (Letalska barvna infrardeča fotografija za določanje zgodnjih potreb po dušiku v koruzi). Agronomy Journal 98 (2006): 968–977._
...
Ta indeks se uporablja za oceno listne odeje in napovedovanje rasti in pridelka. ENVI izračuna zeleni LAI z uporabo naslednje empirične formule iz Boegh et al (2002):
...
Visoke vrednosti LAI se običajno gibljejo od približno 0 do 3,5. Vendar, če prizor vsebuje oblake in druge svetle elemente, ki ustvarjajo nasičene piksle, lahko vrednosti LAI presegajo 3,5. Pred ustvarjanjem slike LAI je idealno, da iz prizora izločite oblake in svetle elemente.
...
_Sklic: Yang, Z., P. Willis in R. Mueller. »Vpliv slike AWIFS z izboljšanim razmerjem pasov na natančnost klasifikacije pridelkov.« Zbornik simpozija Pecora 17 o daljinskem zaznavanju (2008), Denver, CO._

***

## MSAVI2 – modificirani indeks vegetacije, prilagojen tlom 2

Ta indeks je poenostavljena različica indeksa MSAVI, ki so ga predlagali Qi et al (1994) in ki izboljšuje indeks vegetacije, prilagojen tlom (SAVI). Zmanjšuje šum tal in povečuje dinamični razpon signala vegetacije. MSAVI2 temelji na induktivni metodi, ki ne uporablja konstantne vrednosti _L_ (kot pri SAVI) za poudarjanje zdrave vegetacije.
...
Ta indeks uporablja razliko med bližnjimi infrardečimi in rdečimi valovnimi dolžinami, skupaj z NDVI, za poudarjanje zdrave vegetacije. Ni občutljiv na vplive tal in geometrije sončnega opazovanja.

$$
RDVI = {(NIR- Red) \over \sqrt{(NIR + Red)}  }
$$

_Sklic: Roujean, J., in F. Breon. »Ocena PAR, ki ga absorbira vegetacija, na podlagi meritev dvosmerne odbojnosti.« Remote Sensing of Environment 51 (1995): 375–384._

***

## SAVI – indeks vegetacije, prilagojen tleh

Ta indeks je podoben NDVI, vendar zatira učinke pikslov tal. Uporablja faktor prilagoditve ozadja krošnje, _L_, ki je funkcija gostote vegetacije in pogosto zahteva predhodno poznavanje količine vegetacije. Huete (1988) predlaga optimalno vrednost _L_=0,5 za upoštevanje variacij ozadja tal prvega reda. Ta indeks se najbolje uporablja na območjih z relativno redko vegetacijo, kjer je tla vidna skozi krošnjo.
...
Težni koeficient (_a_) lahko znaša od 0,1 do 0,2. Henebry, Viña in Gitelson (2004) priporočajo vrednost 0,2.
