...
Ko prvič zaženete Chloros in Chloros (brskalnik), se bo zagnal njegov backend. Ko bo pripravljen, se bo v levem zgornjem kotu prikazala ikona glavnega menija. <img src=".gitbook/assets/image (1).png" alt="" data-size="line"> .

<figure><img src=".gitbook/assets/header.JPG" alt=""><figcaption></figcaption></figure>

Zgornji naslovnik vsebuje od leve proti desni:
...
Levi stranski meni vsebuje različne ikone za interakcijo:
...
Ko kliknete sliko v glavnem pregledovalniku slik, se ta odpre v celozaslonskem načinu v zavihku Pregledovalnik slik.
...
Stranski trak za prijavo uporabnika vam omogoča prijavo v račun Chloros+, da odklenete napredne funkcije. Ogledate si lahko tudi trenutno različico aplikacije in nastavite jezik prikazanega besedila v Chloros GUI in CLI.
